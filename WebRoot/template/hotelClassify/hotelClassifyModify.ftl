...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="${base}/hotelClassify/hotelClassifyUpdate.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
				...
				<td>
					<input  class="formText" name="hotelClassify.code" value="${hotelClassify.code}" type="text">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelClassify.nameCn" value="${hotelClassify.nameCn}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input  class="formText" name="hotelClassify.nameEn" value="${hotelClassify.nameEn}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea  name="hotelClassify.remarkCn" rows="3" cols="50">${hotelClassify.remarkCn}</textarea >
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea  name="hotelClassify.remarkEn" rows="3" cols="50">${hotelClassify.remarkEn}</textarea >
					<label class="requireField">*</label>
				</td>
			</tr>
			<#--<tr>
				...
				<td>
					<input  class="formText" name="hotelClassify.showLimit" value="${hotelClassify.showLimit}" type="text">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelClassify.sort" value="${hotelClassify.sort}" type="text"  onkeyup="value=value.replace(/[^0-9]/g,'')">
					<label class="requireField">0-1000的数字</label>
				</td>
			</tr>
			<input type="hidden" name="hotelClassify.id" value="${hotelClassify.id}"/>
		</table>
		</div>
