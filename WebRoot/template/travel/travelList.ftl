...
$(document).ready(function(){
	$("#insertButton").click(function(){
		parent.document.getElementById("mainFrame").src ="${base}/travel/insert.htm";
	});
});
function deleteTravel(id){
	if(confirm("你确定要删除吗？")){
		parent.document.getElementById("mainFrame").src ="${base}/travel/delete.htm?travel.id="+id;
	}
}
</script>
</head>
<body class="list">
	...
	<div class="body">
		<form id="listForm" action="${base}/promotion/promotionList.htm" method="post">
			...
			<input id="insertButton" class="formButton" value="添加旅游" hidefocus="" type="button">
			</div>
				...
				<#list pager.list as prl>
					<tr>
						...
						<td>
							...
							<a href="${base}/travel/update.htm?travel.id=${prl.id}" title="[修改]"><font color="green">[修改]</font></a>&nbsp;
							<a href="javascript:void(0);" onclick="deleteTravel(${prl.id})" title="[删除]"><font color="red">[删除]</font></a>
