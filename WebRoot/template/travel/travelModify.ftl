...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/travel/travelUpdate.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			<tr>
				...
				<td>
					<input id="titleCn" class="formText" name="travel.titleCn" value="${travel.titleCn}" type="text">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="travel.titleEn" value="${travel.titleEn}" type="text">
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input  id="bookTell" class="formText" name="travel.bookTell" value="${travel.bookTell}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input id="address" class="formText" name="travel.address" value="${travel.address}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input id="price" class="formText" name="travel.price" value="${travel.price}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input id="beginDatetime" name="travel.beginDatetime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="formText" value="${(travel.beginDatetime?string("yyyy-MM-dd HH:mm"))!}" type="text">-<input id="endDatetime" name="travel.endDatetime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="formText" value="${(travel.endDatetime?string("yyyy-MM-dd HH:mm"))!}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea  name="travel.digestCn" rows="3" cols="50">${travel.digestCn}</textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea  name="travel.digestEn" rows="3" cols="50">${travel.digestEn}</textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea id="editor" name="travel.contentCn" class="editor">${travel.contentCn}</textarea >
					<label class="requireField">*</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea id="editor1" name="travel.contentEn" class="editor">${travel.contentEn}</textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input  class="formText" name="travel.linkeUrl" value="${travel.linkeUrl}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input id="sort" class="formText" name="travel.sort" value="${travel.sort}" type="text" onkeyup="value=value.replace(/[^0-9]/g,'')">
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="travel.showFlg" value="1"<#if travel.showFlg==1>checked </#if>>发布
				</td>
			</tr>
