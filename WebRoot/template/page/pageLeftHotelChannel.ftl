...
<body class="menu">
	<div class="body">
			...
			<dl>
				...
				<dd>
					<a href="${base}/hotelChannel/yueChannelList.htm" target="mainFrame" >悦廷会</a>
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<a href="${base}/hotelChannel/aboutChannelList.htm" target="mainFrame" >关于远洲</a>
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<a href="${base}/hotelClassify/hotelClassifyList.htm " target="mainFrame">广告列表</a>
				</dd>
			</dl>
