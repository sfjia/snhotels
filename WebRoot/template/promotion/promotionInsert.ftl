...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/promotion/promotionInsert.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			<tr>
				...
				<td>
					<input  id="titleCn" class="formText" name="promotion.titleCn" value="" type="text">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="promotion.titleEn" value="" type="text">
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input  id="bookTell" class="formText" name="promotion.bookTell" value="" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input id="beginDatetime"  name="promotion.beginDatetime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="formText" value="" type="text">-<input id="endDatetime" name="promotion.endDatetime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="formText" value="" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea id="editor" name="promotion.digestCn" class="editor"></textarea >
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea id="editor1" name="promotion.digestEn" class="editor"></textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea id="editor2" name="promotion.contentCn" class="editor"></textarea >
					<label class="requireField">*</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea id="editor3" name="promotion.contentEn" class="editor"></textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input id="sort" class="formText" name="promotion.sort" value="" type="text" onkeyup="value=value.replace(/[^0-9]/g,'')">
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="promotion.showFlg" value="1" >发布
				</td>
			</tr>
		</table>
		</div>
