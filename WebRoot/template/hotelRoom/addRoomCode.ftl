		...
		$validateForm.validate({
			rules: {
				...
				"hotelRoomCode.roomCode":{
					...
					remote:{
						type:"POST",
					 	url:"${base}/room/checkRoomCode.htm"
					}
				},
...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/room/roomCodeInsert.htm"  method="post">
		<input type="hidden" id="hotelCode" name="hotelRoomCode.hotelCode" value=${hotelRoomCode.hotelCode} />
		<div class="index">
		<table style="display: table;" class="inputTable tabContent">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelRoomCode.roomCode" value="" type="text">
