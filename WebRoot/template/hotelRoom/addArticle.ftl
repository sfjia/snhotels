		...
		$validateForm.validate({
			rules: {
				...
				"roomColumnArticle.name":{
					...
					remote:{
						type:"POST",
					 	url:"${base}/roomColumn/checkArticleName.htm?checkType=1"
					}
				},
...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/roomColumn/articleInsert.htm"  method="post">
		...
		<table style="display: table;" class="inputTable tabContent">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="roomColumnArticle.name" value="" type="text">
