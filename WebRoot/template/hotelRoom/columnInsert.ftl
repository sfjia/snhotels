		...
		$validateForm.validate({
			rules: {
				...
				"roomColumn.name":{
					...
					remote:{
						type:"POST",
					 	url:"${base}/roomColumn/checkColumnName.htm?checkType=1"
					}
				},
...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/roomColumn/columnInsert.htm"  method="post">
		<div class="index">
		<table style="display: table;" class="inputTable tabContent">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="roomColumn.name" value="" type="text">
