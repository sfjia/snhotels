...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="${base}/hotelAdvert/hotelAdvertInsert.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			<tr>
				...
				<td>
					<input  class="formText" name="hotelAdvert.titleCn" value="" type="text">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelAdvert.titleEn" value="" type="text">
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea  name="hotelAdvert.summaryCn" rows="3" cols="50"></textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea  name="hotelAdvert.summaryEn" rows="3" cols="50"></textarea >
					<label class="requireField"></label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelAdvert.linkeUrl" value="" type="text">
					<label class="requireField"></label>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input  class="formText" id="sort" name="hotelAdvert.sort" value="" type="text" onkeyup="value=value.replace(/[^0-9]/g,'')">
