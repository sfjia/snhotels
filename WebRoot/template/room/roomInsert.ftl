...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/room/roomInsert.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			<tr>
				...
				<td>
				 	<select name="room.hotelCode" id="type"><option value="" selected="selected">请选择</option>
						<option value="qianDaoHu">qianDaoHu</option>
						<option value="hangzhouXiHu">hangzhouXiHu</option>
						<option value="taiHu">taiHu</option>
			...
			<tr>
				...
				<td>
					<input  class="formText" name="room.roomCode" value="" type="text">
			...
			<tr>
				...
				<td>
					<input  class="formText" name="room.roomName" value="" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input  class="formText" name="room.roomArea" value="" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="checkbox" name="room.netStatus" value="1" >有免费上网
				</td>
			</tr>
			<tr>
				<th style="width:150px;text-align:right;">
				...
				<td>
					<input type="checkbox" name="room.showStatus" value="1" >有淋浴
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="checkbox" name="room.bathtubStatus" value="1" >有浴缸
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input  class="formText" name="room.sort" value="" type="text">
				</td>
			</tr>
			<tr>
				<th style="width:150px;text-align:right;">
				...
				<td>
					<input  class="formText" name="room.linkUrl" value="" type="text">
				</td>
			</tr>
			<tr>
				<th style="width:150px;text-align:right;">
				...
				<td>
					<input  class="formText" name="room.price" value="" type="text">
				</td>
			</tr>
			<tr>
				<th style="width:150px;text-align:right;">
				...
				<td>
					<input type="checkbox" name="room.statusCodeWeb" value="1" >网站
					<input type="checkbox" name="room.statusCodePad" value="1">PAD
					<input type="checkbox" name="room.statusCodeApp" value="1" >APP
					<input type="checkbox" name="room.statusCodeWap" value="1">WAP
				</td>
			</tr>
		</table>
		</div>
			...
			<table style="display: table;" class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<textarea  name="room.roomDigestdWeb" rows="3" cols="50"></textarea >
						<label class="requireField">*</label>
					</td>
				</tr>
				<#--<tr>
			...
			<table style="display: none;" class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<textarea  name="room.roomDigestdPad" rows="3" cols="50"></textarea >
						<label class="requireField">*</label>
					</td>
				</tr>
			</tbody></table>
			...
			<table style="display: none;" class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<textarea  name="room.roomDigestdApp" rows="3" cols="50"></textarea >
						<label class="requireField">*</label>
					</td>
				</tr>
			</tbody></table>
			...
			<table style="display: none;" class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<textarea  name="room.roomDigestdWap" rows="3" cols="50"></textarea >
						<label class="requireField">*</label>
					</td>
				</tr>
			</tbody></table>
