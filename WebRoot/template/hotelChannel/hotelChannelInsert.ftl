...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/hotelChannel/hotelChannelInsert.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			...
			<tr>
				...
				<td>
					<select name="hotelChannel.parentId" id="type"><option value="0" selected="selected">最顶级</option>
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelChannel.sort" value="" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<#--<tr>
