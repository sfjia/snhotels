...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/hotelChannel/hotelChannelUpdate.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			...
			<tr>
				...
				<td>
					<select name="hotelChannel.parentId" id="type"><option value="0" <#if hotelChannel.parentId=="0"> selected </#if>>最顶级</option>
						<option value="1" <#if hotelChannel.parentId=="1"> selected </#if>>首页 </option>
						<option value="2" <#if hotelChannel.parentId=="2"> selected </#if>>成员酒店 </option>
						<option value="3" <#if hotelChannel.parentId=="3"> selected </#if>>悦廷会 </option>
						<option value="4" <#if hotelChannel.parentId=="4"> selected </#if>>优惠精选</option>
						<option value="5" <#if hotelChannel.parentId=="5"> selected </#if>>旅游度假</option>
						<option value="6" <#if hotelChannel.parentId=="6"> selected </#if>>人员招聘 </option>
						<option value="7" <#if hotelChannel.parentId=="7"> selected </#if>>关于远洲 </option>
					</select>
				</td>
			<tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input  class="formText" name="hotelChannel.sort" value="${hotelChannel.sort}" type="text">
					<label class="requireField">*</label>
				</td>
			</tr>
			<tr>
