...
$(document).ready(function(){
	$("#insertButton").click(function(){
		parent.document.getElementById("mainFrame").src ="${base}/hotelChannel/yueInsertTo.htm";
	});
});
...
<body class="list">
	...
	<div class="body">
		<form id="listForm" action="${base}/hotelChannel/yueChannelList.htm" method="post">
			<div class="listBar">
			...
			<table id="listTable" class="listTable">
				<tbody><tr>
					...
					<#--<th>
						<a href="#" class="sort" name="name" hidefocus="">栏目编码</a>
					</th>-->
					<th>
				...
				<#list pager.list as prl>
					<tr>
						...
						<td>
							...
							<a href="${base}/hotelChannel/yueUpdateTo.htm?hotelChannel.id=${prl.id}" title="[修改]" target="mainFrame" ><font color="green">[修改]</font></a>&nbsp;
						</td>
					</tr>
