...
<body class="input">
	...
	<div class="body">
		<form id="validateForm" class="form" action="/hotelChannel/aboutUpdate.htm" enctype="multipart/form-data" method="post">
		<div class="index">
		<table class="listTable">
			...
			<tr>
				...
				<td>
					...
					<label class="requireField">若此栏目为人员招聘，则必填此项且为：11</label>
				</td>
			</tr>-->
			<tr>
				<th style="width:150px;text-align:right;">
				...
				<td>
				 	<select name="hotelChannel.tyep"id="type"><option value="" selected="selected">请选择</option>
						...
						<option value="4" <#if hotelChannel.tyep=="4"> selected </#if>>招聘页</option>
					</select>
				</td>
			</tr>
			<tr>
