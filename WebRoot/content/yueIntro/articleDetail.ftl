  ...
  <div class="up" style=" float: left;">
   ...
   <#include "/content/yueIntro/leftNav.ftl">   	
     <div class="right_neirong" style=" float:right; width:770px;">
        ...
        <a href="/index.htm" style=" color:#ab7b3e; padding-right:5px;">远洲酒店首页</a><span style=" color:#ab7b3e; padding-right:5px;">></sapn><sapn style=" color:#ab7b3e; padding-right:5px;">悦廷会</sapn><sapn style=" color:#ab7b3e; padding-right:5px;">></sapn><sapn  style=" color:#ab7b3e; padding-right:5px;">${hotelArticle.titleCn}</sapn>
