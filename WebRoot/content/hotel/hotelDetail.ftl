     ...
     <div class="right_neirong" style=" float:right; width:770px;">
        ...
        <input type="hidden" id="type" name="type" value=${type} />
         ...
         <#list pager.list as article>
           <ul style=" float:left; background:#fffeee; width:730px; padding-top:20px; border-bottom:1px solid #c2a06b;">
              <li style=" float:left; width:210px; height:130px; padding-top:5px;margin-bottom:15px; border:1px solid #a1a1a1; background:#fff; text-align:center; margin-left:5px; "><img src="${article.articleImage}" width="200" height="125"/></li>
              <li style=" float:left; width:480px; margin-left:20px;">
                 <ul>
                    <li style=" color:#80501b;font-size:18px;">${article.articleTitle}</li>
                    <li style="color:#666666; font-family:'宋体'; line-height:20px; margin-top:10px;">
                    <#if article.articleNoteShow?length lt 150>
           					${article.articleNoteShow?default("")}
     			 		<#else>
           					${article.articleNoteShow[0..150]?default("")}.....
						</#if></li>
                    
                    <li style="color:#666666; font-family:'宋体';"></li>
                    <li style=" padding-bottom:30px;"><a href="${base}/hotel/detailMes.htm?code=${code}&type=${type}&hotelColumnArticle.id=${article.id}" style=" display:inline-block; background:url(/statics/img/right.png) no-repeat 52px center; width:60px; color:#ab7b3e; float:right;">更多详情</a></li>
                 </ul>
              </li>
           </ul><!--1 end--> 
		</#list>
