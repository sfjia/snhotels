...
<body class="big_wrap">
 ...
 <#include "/content/common/user_center_left.ftl">
     ...
     <input type="hidden" id="columnCode" name="hotelColumn.columnCode" value=${hotelColumn.columnCode} />
        ...
        <form id="listForm" action="${base}/hotel/detail.htm?code=${code}&type=KHFW" method="post">
          <#list pager.list as article>
        <div class="right_sty" style=" width:730px; margin:0 auto;" id="test">
			<span style="display:inline;font-size:14px;">${article.articleTitle}<br />
				${article.articleNoteHide}
			<br/> <br/>
          </div><!--right_sty end-->
       </#list>
     <#if (pager.list?size > 0)>
       <div class="right_sty" style=" width:730px; margin:0 auto;" id="test">
       <a href="javascript:window.history.back();"  style=" color:#ab7b3e; padding-right:5px;" >返回>> </a>
       </div><!--right_sty end-->
